...
model_choices = ["VFIT_S", "VFIT_B", "VFI", "SKETCH"]
...
learn_arg.add_argument('--test_batch_size', type=int, default=8)
learn_arg.add_argument('--start_epoch', type=int, default=0)
learn_arg.add_argument('--max_epoch', type=int, default=80)
...
parser.add_argument('--result_dir', default='/home/kuhu6123/jshe2377/ldfi-sketch/Video-Frame-Interpolation-Transformer/sfi-result', type=str)

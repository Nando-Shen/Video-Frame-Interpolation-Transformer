...
model_choices = ["VFIT_S", "VFIT_B", "VFI"]
model_arg.add_argument('--model', choices=model_choices, type=str, default="VFI")
...
parser.add_argument('--result_dir', default='halfmix-vfit', type=str)
